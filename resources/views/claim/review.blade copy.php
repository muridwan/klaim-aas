    ...
    <div class="row">
      <div class="col-lg-12">
        <form action="{{ route('review_action') }}" method="POST" autocomplete="off">
          ...
          <input type="hidden" name="recom_uuid" value="{{ $claim->recommendations->first()->uuid }}">
          <div class="card card-success card-outline card-tabs">
            <div class="card-body">
                ...
                <div class="col-lg-6 px-3">
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td class="border-right">
                        <b> {{ old('incident_date') ?? date('d-m-Y', strtotime($claim->incident_date)) }}</b>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td class="bg-secondary font-weight-bold">PENYEBAB KLAIM</td>
                      <td class="border-right">
                        <b> {{ number_format($claim->claim_amount) }}</b>
                      </td>
                    </tr>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <input type="checkbox" value="1" id="" @checked($document->is_accepted == 1)
                        name="decisions[{{$loop->iteration-1}}]">
                      </td>
                      <td>
                        <textarea id="" name="remarks[{{ $loop->iteration-1 }}]" data-row="{{ $loop->iteration }}"
                          class="form-control file_remarks" id="file-remarks-{{$loop->iteration}}"
              ...
              <div class="form-group mt-2">
                <label for="recom_note">
                  <i class="fa fa-info-circle"></i> CATATAN ANALIS KLAIM
                </label>
                <textarea class="form-control" id="recom_note" name="recom_note"
                  rows="3">{{ $claim->recommendations->first()->description ?? '' }}</textarea>
              </div>
              <div class="form-group form-check">
                <input type="checkbox" class="form-check-input" id="all_done" name="all_done" value="1" @checked(
                  $claim->recommendations->first()->suggestion == 1)>
